...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#FEDF78] font-Point">
      <button className="text-[#846144] text-5xl mb-6 focus:outline-none" onClick={handleGoToMainPage}>
        멍멍냥냥
      </button>
      <input
      ...
      <button
        className="w-80 h-12 p-3 mb-4 rounded-xl bg-[#FFCB4F] text-[#39442D] text-lg focus:outline-none"
        onClick={handleLogin}
      >
        로그인
      </button>
      <button
        className="bg-[#FEDF78] text-sm text-black underline focus:outline-none"
